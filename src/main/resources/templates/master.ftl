...
<header class="head">
    <div class="head_logo_div">
        <img class="logo_img" src="../static/master/images/upload/head.jpg"></a>
    </div>
...
<div class="wrapBox" id="wrapBox">
    <div class="box">
        <img class="box_bg" src="../static/master/images/upload/pic_1.jpg">
            ...
            <div class="head_div">
                <div class="cycle_item">
                    ...
                    <div class="green_cycle">
                        <img class="green_cycle_img" src="../static/master/images/icon/green_cycle.svg">
                        <div class="yellow_cycle">
                            <img class="yellow_cycle_img" src="../static/master/images/icon/yellow_cycle.svg">
                            <div class="blue_cycle">
                                <img class="blue_cycle_img" src="../static/master/images/icon/blue_cycle.svg">
                                <div class="head_img_div">
                                    <img class="head_img" src="../static/master/images/upload/head.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="arrow_div">
            <img class="arrow_img" src="../static/master/images/icon/arrowhead.png">
        </div>
    </div>

    <div class="box">
        <img class="box_bg" src="../static/master/images/upload/pic_2.jpg">
    ...
    <div class="box">
        <img class="box_bg" src="../static/master/images/upload/pic_3.jpg">
        ...
        <div class="box_content box03_content">
            ...
            <div class="left_div" id="left_div">
                <img class="left_arrow" src="../static/master/images/icon/arrowleft.png">
            </div>
            <div class="right_div" id="right_div">
                <img class="right_arrow" src="../static/master/images/icon/arrowright.png">
            </div>
        </div>
    ...
    <div class="box">
        ...
        <img class="box_bg" src="../static/master/images/upload/pic_4.jpg">
            ...
            <ul class="hobby_content">
                <li class="hobby_01">
                    <div class="hobby_img_div">
                        ...
                        <div class="hobby_img">
                            <img src="../static/master/images/upload/kapok.jpg">
                        </div>
                ...
                <li class="hobby_02">
                    <div class="hobby_img_div">
                        ...
                        <div class="hobby_img">
                            <img src="../static/master/images/upload/acg.png">
                        </div>
                        <div class="hobby_img_info">
                            <h1>ACG</h1>
                            <h2>动漫&视频&lol</h2>
                ...
                <li class="hobby_03">
                    <div class="hobby_img_div">
                        ...
                        <div class="hobby_img">
                            <img src="../static/master/images/upload/reading.jpg">
                        </div>
                        <div class="hobby_img_info">
                            <h1>文学</h1>
                            <h2>历史&写作</h2>
        ...
        <div class="foot_info_main">
            ...
            <div class="qrcode_div">
                    <span class="weixin">
                        ...
                        <img class="weixin_img" src="../static/master/images/upload/weixin_qr.png">
                    </span>
                <span class="dingding">
                        <a class="dingding_icon"></a>
                        <img class="dingding_img" src="../static/master/images/upload/dingding_qr.png">
                    </span>
                <span class="qq">
                        <a class="qq_icon"></a>
                        <img class="qq_img" src="../static/master/images/upload/qq_qr.jpg">
                    </span>
            </div>
        </div>
...
<script type="text/javascript" src="../static/master/js/main.js"></script>
</body>
